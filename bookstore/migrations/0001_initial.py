    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('billing_address', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='billing', to='bookstore.Address')),
                ('payment_info', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='bookstore.Payment')),
                ('shipping_address', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='shipping', to='bookstore.Address')),
            ],
            options={
                'db_table': 'user',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_name', models.CharField(blank=True, max_length=45)),
                ('phone_number', models.CharField(blank=True, max_length=20)),
                ('promotion_status', models.CharField(default='Unsubscribed', max_length=14)),
        ...
        migrations.AddField(
            model_name='payment',
            name='user_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='bookstore.UserInfo'),
        ),
        migrations.AddField(
            model_name='order',
            name='payment',
